...
export default function Header() {
  ...
  return (
    <header className="fixed top-0 left-0 w-full z-50 bg-[#0f1c2e]/80 backdrop-blur-md border-b border-white/10 dark:bg-black/80">
      <nav className="flex justify-between items-center max-w-7xl mx-auto px-6 py-4">
        ...
        {/* Navigation Links */}
        <div className={`${isOpen ? 'flex' : 'hidden'} md:flex flex-col md:flex-row absolute md:static top-full left-0 w-full md:w-auto bg-[#0f1c2e] md:bg-transparent p-6 md:p-0 gap-6 text-sm font-medium items-center shadow-lg md:shadow-none`}>
          ...
          {/* CTA Button - ظاهر في الـ mobile والـ desktop */}
          <Link 
            href="/inscription" 
